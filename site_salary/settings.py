"""
Django settings for site_salary project.
...
SECRET_KEY = '!%)!fvl%2*kdu^j0^5m(0=8et(i*&_l)_n0_*e1ak14221xg8xv'
...
WSGI_APPLICATION = 'site_salary.wsgi.application'
